...
const getImageUrl = (path) => {
  if (!path) return "https://via.placeholder.com/150?text=No+Img"; // Placeholder default
  if (path.startsWith("http")) return path; // Jika sudah absolute URL (misal dari google)

  // Hapus '/api' dari BASE_URL jika ada, karena folder uploads biasanya sejajar dengan folder api
  // Contoh: http://localhost:5001/api -> http://localhost:5001
                      ...
                      >
                        <td>
                          ...
                          >
                            ...
                            {p.Images && p.Images.length > 0 ? (
                              <img
                                src={getImageUrl(p.Images[0]?.image_path)}
                                alt={p.name}
                                style={{
                                  width: "100%",
                                  height: "100%",
                        ...
                        <td className="text-center">
                          {isOutOfStock ? (
                            ...
                            <span
                              className={`fw-bold ${
                                currentStock <= (p.Stock?.stock_minimum || 0)
                                  ? "text-warning"
                                  : "text-dark"
                              }`}
                            >
